...
namespace Twentythree
{
    ...
    public class APIProvider : IAPIProvider
    {
        ...
        public XPathNavigator DoRequest(MessageReceivingEndpoint AMessage)
        {
            ...
            IncomingWebResponse Response = this.OAuthConsumer.PrepareAuthorizedRequestAndSend(AMessage, this.AccessToken);
            ...
            {
                if (ResponseCheckIterator.Current.GetAttribute("status", "") != "ok") return null;
            }
        ...
        {
            return "http://" + this.ConsumerDomain + Method + (Parameters.Count > 0 ? "?" + String.Join("&", Parameters.ToArray()) : "");
        }
    }
}
