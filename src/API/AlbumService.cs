...
namespace Twentythree
{
    public class AlbumService
    {
        ...
        public bool Delete(int AlbumId)
        {
            ...
            // Do the request
            MessageReceivingEndpoint RequestMessage = new MessageReceivingEndpoint(this.Provider.GetRequestURL("/api/album/delete", RequestURLParameters), HttpDeliveryMethods.GetRequest);
