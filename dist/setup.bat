...
:LInitialize
    ...
    set Install=
    set Uninstall=
    set PackageFile=%~dp0Twentythree.wsp
    set PackageName=Twentythree.wsp
...
:LValidate
    ...
    if exist "%SPFeaturesLocation%\WebParts" (
       echo Error: Feature folder WebParts already exists in current SharePoint.
       set ValidationFailed=1
    )

    if exist "%SPFeaturesLocation%\WebParts_2" (
       echo Error: Feature folder WebParts_2 already exists in current SharePoint.
       set ValidationFailed=1
    )
...
:LDeploy
    ...
    echo Activating feature WebParts ...
    "%SPAdminTool%" -o activatefeature -id a7c967ca-a792-4f7e-bc9f-89b2d215fdd2 -url %TargetSiteUrl%

    echo Activating feature WebParts_2 ...
    "%SPAdminTool%" -o activatefeature -id a0e16d5c-1c2a-4f17-8355-0b9cb93736a6 -url %TargetSiteUrl%
...
@rem----------------------------------------------------------------------
:LRetract
    echo Deactivating feature WebParts ...
    "%SPAdminTool%" -o deactivatefeature -id a7c967ca-a792-4f7e-bc9f-89b2d215fdd2 -url %TargetSiteUrl% -force

    echo Uninstalling feature WebParts ...
    "%SPAdminTool%" -o uninstallfeature -id a7c967ca-a792-4f7e-bc9f-89b2d215fdd2 -force

    echo Deactivating feature WebParts_2 ...
    "%SPAdminTool%" -o deactivatefeature -id a0e16d5c-1c2a-4f17-8355-0b9cb93736a6 -url %TargetSiteUrl% -force

    echo Uninstalling feature WebParts_2 ...
    "%SPAdminTool%" -o uninstallfeature -id a0e16d5c-1c2a-4f17-8355-0b9cb93736a6 -force
